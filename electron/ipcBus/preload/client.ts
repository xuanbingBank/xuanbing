/**
 * @file 实现 preload 内部使用的安全 IPC 客户端，包含统一结果解包、校验与订阅管理。
 */
...
/**
 * 描述 preload 所需的最小 ipcRenderer 接口。
 */
