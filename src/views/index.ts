...
> = {
  ...
  collection_codecollection: () => import('./collection/codecollection/index.vue'),
  collection_fictioncollection: () => import('./collection/fictioncollection/index.vue'),
  collection_imgcollection: () => import('./collection/imgcollection/index.vue'),
  collection_videocollection: () => import('./collection/videocollection/index.vue'),
  collection_webcollection: () => import('./collection/webcollection/index.vue'),
  ...
  dashboard_dataauxiliaryscreen: () => import('./dashboard/dataauxiliaryscreen/index.vue'),
  ...
  music_localmusic: () => import('./music/localmusic/index.vue'),
  music_meshmusic: () => import('./music/meshmusic/index.vue'),
  node_knowledgebase: () => import('./node/knowledgebase/index.vue'),
  node_notebase: () => import('./node/notebase/index.vue'),
  ...
  task_done: () => import('./task/done/index.vue'),
  task_progress: () => import('./task/progress/index.vue'),
  task_unfinished: () => import('./task/unfinished/index.vue'),
  video_localvideo: () => import('./video/localvideo/index.vue'),
  video_meshvideo: () => import('./video/meshvideo/index.vue')
};
