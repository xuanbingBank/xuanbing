...
export function defineState<T extends object>(initialState: T): T {
  return Vue.reactive(initialState) as T
}
 ...
 * @returns 响应式引用。
 */
export function computedRef<T>(getter: () => T): Ref<T> {
 ...
 */
const storeRegistry = new Map<string, StoreBase>()
 ...
 */
export function registerStore(store: StoreBase): void {
 ...
 */
export function getStore(id: string): StoreBase | undefined {
